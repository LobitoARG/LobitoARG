 👋 Hi, I’m @LobitoARG AKA Alejandro Jabo
 
Im 24 years old and i recently graduated at [Digital House](https://www.digitalhouse.com/ar) the biggest Latin American Ed-Tech company as a web developer full stack

```I identify as a fast learner, i like to work hard to accomplish my goals.```<br>
```I never stop learning new things to implement in my proyects.```<br>
```Also, i enjoy working as a team ```

In my time studying at Digital House, I learn a lot of technologies such as:
...
Right now my main proyect is: [Argentium3.0 E-Commerce](https://github.com/LobitoARG/Grupo_3_Argentium3.0)

The webpage allows the user to complete a register form, log in wich is connected to a local database
Each form has his own validatation using middlewares and js 

Also, you can simulate buying an item by adding it to the cart. All the items are saved using Local Storage.
...
By using Browser Router/Routes/Route/NavLink i was able to create a SPA webpage.
